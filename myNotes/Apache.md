...
![Скрин вывода поиска по слову nginx](img/nginx.png)
...
![Скрин состояния docker images](img/c.png)
...
fastfetch
```
![Вывод команды fastfetch](img/l.png)
